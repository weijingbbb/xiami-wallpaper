  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.f(randomList.value, (item, k0, i0) => {
          return {
            a: item.smallPicurl,
            b: item._id,
        ...
        e: common_vendor.f(classifyList.value, (item, k0, i0) => {
          return {
            a: item._id,
            b: "1cf27b2a-5-" + i0,
            c: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-1cf27b2a"], ["__file", "/Users/weijing/ExerciseProject/uniapp/xiami-wallpaper/pages/index/index.vue"]]);
